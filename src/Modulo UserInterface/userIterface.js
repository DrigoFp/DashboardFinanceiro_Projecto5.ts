...
exports.criarEstrutura = criarEstrutura;
exports.renderizarTransacoes = renderizarTransacoes;
exports.renderizarCards = renderizarCards;
...
function criarTransacao(descricao, valor, categoria, tipo) {
    return {
        id: Date.now(),
        descricao,
        valor,
